    ...
    <div class="bg-white rounded-[2rem] shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden relative">
        ...
        <div class="px-8 py-6 bg-[#335A92] text-white flex flex-col sm:flex-row justify-between items-center gap-4 relative overflow-hidden">
             ...
             <div class="relative z-10 flex items-center gap-4">
                 ...
                 <div>
                    <h2 class="text-2xl font-bold tracking-tight">Editar Subcategoría</h2>
                    <p class="text-blue-100 text-sm font-medium">Actualiza los detalles de la clasificación</p>
                 </div>
             </div>
        ...
        <div class="p-8 relative z-10">
            {!! Form::model($subcategoria, ['route' => ['admin.subcategorias.update', $subcategoria], 'method' => 'put', 'class' => 'space-y-8']) !!}
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                        <label class="cursor-pointer">
                            {!! Form::radio('estado', 1, null, ['class' => 'peer sr-only']) !!}
                        ...
                        <label class="cursor-pointer">
                            {!! Form::radio('estado', 0, null, ['class' => 'peer sr-only']) !!}
