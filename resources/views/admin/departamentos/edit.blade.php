<x-admin-layout>
    <div class="bg-white dark:bg-gray-800 rounded-3xl shadow-xl border border-gray-100 dark:border-gray-700 overflow-hidden relative">
        ...
        <div class="p-6 border-b border-gray-100 dark:border-gray-600 bg-white/50 dark:bg-gray-800/50 backdrop-blur-sm relative z-10 flex flex-col sm:flex-row justify-between items-center gap-4">
            <div>
                <h2 class="text-xl font-bold text-gray-800 dark:text-white flex items-center">
                    <i class="fas fa-edit text-primary-600 mr-2 bg-primary-50 p-2 rounded-lg"></i>
                    <span class="tracking-tight">Editar Departamento</span>
                </h2>
        ...
        <div class="p-8 relative z-10">
            {!! Form::model($departamento, ['route' => ['admin.departamentos.update', $departamento], 'method' => 'put', 'enctype' => 'multipart/form-data', 'class' => 'space-y-6']) !!}
                ...
                {{-- Jefe Firma --}}
                 <div x-data="{ fileName: '' }">
                    ...
                    @if($departamento->jefe_firma)
                        <div class="mb-4">
                            <p class="text-xs text-gray-500 mb-1">Firma Actual (Elige un archivo para reemplazarla):</p>
                            <img src="{{ Storage::url($departamento->jefe_firma) }}" alt="Firma Actual" class="h-20 border rounded p-1 bg-white">
                        </div>
                    @endif
                    ...
                    <div class="flex items-center justify-center w-full">
                        <label for="jefe_firma" class="flex flex-col items-center justify-center w-full h-32 border-2 border-gray-300 border-dashed rounded-2xl cursor-pointer bg-gray-50 hover:bg-gray-100 transition-all group">
                            <div class="flex flex-col items-center justify-center pt-5 pb-6">
                                ...
                                <p class="mb-2 text-sm text-gray-500" x-show="!fileName"><span class="font-semibold">Click para actualizar firma</span></p>
