<x-instructor-layout>
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div class="bg-white rounded-[2rem] shadow-xl shadow-gray-200/50 border border-gray-100 overflow-hidden relative">
            ...
            {{-- Header Corporativo --}}
            <div class="bg-[#335A92] px-10 py-8 relative overflow-hidden">
                ...
                <h1 class="text-3xl font-bold text-white relative z-10">Crear Nuevo Curso</h1>
                <p class="text-blue-100 mt-2 text-lg relative z-10">Empieza a construir tu legado educativo.</p>
            </div>
            
            <div class="p-10">
                {!! Form::open(['route' => 'author.cursos.store', 'files'=> true, 'autocomplete' => 'off']) !!}
    ...
    <x-slot name="js">
        ...
        <script src="{{ asset('js/author/curso-form.js') }}"></script> {{-- Extraer JS a archivo externo si es posible, o mantener inline --}}
                    ...
                    reader.onload = function (e) {
                        ...
                        img.onload = function () {
                            if (img.width < maxAncho || img.height < maxAlto) {
                                // dimensionesError.innerHTML = 'Las dimensiones sugeridas son ' + maxAncho + 'x' + maxAlto + 'px.';
                                // No limpiar valor, solo advertencia
                            } else {
                                dimensionesError.innerHTML = '';
                            }
                        };
                    };
