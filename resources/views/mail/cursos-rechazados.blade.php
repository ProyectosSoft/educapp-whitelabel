...
<body>
    <div class="container">
        ...
        <p class="rejection-message">Lamentamos informarte que, después de una cuidadosa revisión, el curso <strong>"{{ $nombrecurso }}"</strong> no cumple completamente con nuestros criterios en este momento. Queremos agradecerte sinceramente por tu esfuerzo y dedicación al crear y presentar este curso.</p>

        <p>Entendemos que esto puede ser desalentador, pero te animamos a revisar nuestros lineamientos y considerar realizar mejoras. Estamos aquí para ayudarte y esperamos ver tus futuros cursos con éxito en nuestra plataforma.</p>

        <p class="additional-info">Además, ten en cuenta que puedes revisar las sugerencias y comentarios detallados directamente en la aplicación. Valoramos tu contribución y estamos aquí para apoyarte en el proceso de mejora.</p>

        <p class="additional-info">Gracias por tu comprensión y por ser parte de nuestra comunidad educativa.</p>
