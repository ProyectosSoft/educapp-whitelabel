        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div class="bg-[#335A92] px-10 py-8 relative overflow-hidden flex justify-between items-center">
                ...
                <div class="relative z-10">
                    <h1 class="text-3xl font-bold text-white">Cupones de Descuento</h1>
                    <p class="text-blue-100 mt-2 text-lg truncate max-w-2xl">Crea y gestiona códigos promocionales para tu curso.</p>
                </div>
                <div class="relative z-10" x-data="{ open: @entangle('openForm') }">
            ...
            <div class="px-8 py-8" x-data="{ open: @entangle('openForm') }">
                ...
                <div x-show="open" x-transition:enter="transition ease-out duration-300" x-transition:enter-start="opacity-0 transform scale-95" x-transition:enter-end="opacity-100 transform scale-100" class="mb-8 bg-gray-50 rounded-xl border border-gray-200 p-6">
                    ...
                    <div class="mt-6 flex justify-end space-x-3">
                        ...
                        <button wire:click="storeOrUpdate" class="px-4 py-2 text-sm font-bold text-white bg-[#335A92] rounded-lg hover:bg-[#284672] transition shadow-md">
