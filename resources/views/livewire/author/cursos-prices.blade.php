        ...
        <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 items-start">
            ...
            <div class="bg-[#335A92] px-10 py-8 relative overflow-hidden flex justify-between items-center">
                ...
                <div class="relative z-10">
                    <h1 class="text-3xl font-bold text-white">Tarifas y Precios</h1>
                    <p class="text-blue-100 mt-2 text-lg truncate max-w-2xl">Configura los precios y descuentos para tu curso.</p>
                </div>
